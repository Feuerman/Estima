...
$(document).ready(function(){
	...
	$('.main-menu-slider').slick({
		arrows: true,
		nextArrow: $('.main-menu-slider .arrow-next'),
		prevArrow: $('.main-menu-slider .arrow-prev'),
		slidesToShow: 2,
		rows: 3
	});
  ...
  // 		autoplaySpeed: 5000,
	...
	$('.history-slider').slick({
		...
		fade: true,
		speed: 1000,		
		asNavFor: '.history-slider-years, .history-slider-bg',
	...
	$('.history-slider-years').slick({
		...
		cssEase: 'ease-in-out',
		speed: 1000,
		asNavFor: '.history-slider, .history-slider-bg',
		responsive: [
			{
			breakpoint: 600,
			settings: {	
